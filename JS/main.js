/* Matn uzunligi topish */
/*let matn = "Assalomu alaykum shogirtlar!";
...
/* replace(so'zlarni almashtirish qo'yish */
...
/* Push & Pop (Arrayga ma'lumot kiritish va chiqarib olish)*/
/*let list = [];
list.push('Firemen');
list.push('Freedom')
list.push('Police')
list.push('Olov Dalbayobov Musorovich');
list.push('Saman');
list.push("Ozod do'xtir")
console.log(list)
...
/* Unshift & Shift (Arrayga ma'lumot kiritish va chiqarib olish) */
/*let list = [];
list.unshift('Olov ');
list.unshift('Kamol');
list.unshift('Bekzod')
...
/*let list = ['Kamal','OlovIT','Ozod','Begi','Muhammadamin','Shaxzod'];
